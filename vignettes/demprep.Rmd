...
Table: Valid interval labels

| Units| Age     | Period   | Cohort     |
|:-----|---------|----------|------------|
| years | `"0"`, `"5-9"`, `"100+"` | `"2020"`, `"2025-2030"` | `"<2010"`, `"2020"`, `"2025-2030"` |
| quarters | `"12"`, `"400+"` | `"2020 Q1"` | `"<2010 Q3"`, `"2020 Q1"` |
| months | `"36"`, `"1200+"` | `"2020 Jan"` | `"<2010 Jul"`, `"2020 Jan"` |
