...
By setting `month_start` to `July`, however, we can shift the start date for all periods to 1 July. The labels are then intepreted as follows.
...
### The `dtabs_survey` function for survey data
