...
Use functions from base *R* or elsewhere to read the data into a data frame, put any date variables into a "year-month-day" format, and tidy any variables not related to age, period, or cohort.
...
## The `as_data_range` functions for converting to labels that use explicit dates
