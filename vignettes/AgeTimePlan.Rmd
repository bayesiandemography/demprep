...
```{r}
dth_age_yr <- deaths
dth_age_yr$br_max_2 <- date_to_age_year(date = dth_age_yr$date,
dob = dth_age_yr$dob,
break_max = 10)
dth_age_yr
```
...
```{r}
dth_age_yr$br_max_1 <- date_to_age_year(date = dth_age_yr$date,
dob = dth_age_yr$dob,
break_max = 6)
dth_age_yr
```
...
dth_age_multi$wth_2 <- date_to_age_multi(date = dth_age_multi$date,
...
dth_age_custom$br_1_5 <- date_to_age_custom(date = dth_age_custom$date,
...
dth_age_month$max <- date_to_age_month(date = dth_age_month$date,
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_age_month(date = dth_age_month$date,
dob = dth_age_month$dob,
break_max = 20)
```
