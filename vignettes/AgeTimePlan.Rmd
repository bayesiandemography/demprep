...
- Demography works with intervals (example)
- Raw data works uses dates (example)
- Turning dates into intervals trickier than appears
  - decisions about lengths of periods, age groups, etc
  - leap years, open age groups, etc
- functions look after details
