...
deaths <- data.frame(name = c("Anwar", "Baptiste", "Candice"),
                     date_birth = c("2014-02-14", "2012-01-04", "2019-04-29"),
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_multi(date = deaths_temp$date_death)
```
...
```{r}
deaths_temp$period_01 <- date_to_period_multi(date = deaths_temp$date_death,
                                              origin = 2001)
deaths_temp
```
...
```{r}
deaths_temp <- deaths
deaths_temp$time <- date_to_period_custom(date = deaths_temp$date_death,
                                          breaks = c("2018-01-01",
                                                     "2020-01-01",
                                                     "2025-01-01"))
deaths_temp
...
dth_per_quarter$time <- date_to_period_quarter(deaths_temp$date_death)
dth_per_quarter
```

```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_quarter(dth_per_quarter$date_death)
```
...
dth_per_month$time <- date_to_period_month(deaths_temp$date_death)
dth_per_month
```

```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_month(dth_per_month$date_death[1:2])
```
...
<!-- ```{r} -->
<!-- dth_per_yr <- deaths -->
<!-- dth_per_yr$time_closed <- date_to_cohort_year(date = dth_per_yr$date_death) -->
<!-- dth_per_yr -->
<!-- ``` -->

<!-- ```{r, echo = FALSE, fig.height = 1.75} -->
<!-- plot_date_to_cohort_year(date = dth_per_yr$date_death) -->
<!-- ``` -->


<!-- ```{r} -->
<!-- dth_per_yr$time_open <- date_to_cohort_year(date = dth_per_yr$date_death, -->
<!--                                             open_first = TRUE) -->
<!-- dth_per_yr -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- dth_per_yr$time_min <- date_to_cohort_year(date = dth_per_yr$date_death, -->
