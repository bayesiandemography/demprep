...
plot_date_to_period_year(date = deaths$date_death)
```
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_year(date = deaths_temp$date_death,
                         month_start = "Jul")
```
...
In most cases, keeping track of intermediate years, and including them in tabulations even when no events occur, is exactly what we want. If we are tracking annual deaths, we want to know that there were no deaths in 2018.

In some cases, however, we only want to keep track of periods with non-zero counts. In these cases, we can set the `as_factor` argument to `FALSE`:
```{r}
deaths_temp$period_nonfac <- date_to_period_year(date = deaths_temp$date_death,
                                                 as_factor = FALSE)
deaths_temp
```

Tabulations of the resulting output will omit the periods with zero counts:
```{r}
table(deaths_temp$period_nonfac)
```
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_custom(date = deaths_temp$date_death,
                           breaks = c("2018-12-01",
                                      "2019-12-01",
                                      "2024-12-01"))
```
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_quarter(deaths_temp$date_death)
```
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_period_month(deaths_temp$date_death[1:2])
```
...
<!-- ```{r, echo = FALSE, fig.height = 6.5} -->
<!-- plot_date_to_age_year(date = dth_age_yr$date_death, -->
<!--                       dob = dth_age_yr$dob, -->
<!--                       break_max = 10) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6} -->
<!-- plot_date_to_age_multi(date = dth_age_multi$date_death, -->
<!--                        dob = dth_age_multi$dob, -->
<!--                        break_max = 10) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6} -->
<!-- plot_date_to_age_custom(date = dth_age_custom$date_death, -->
<!--                         dob = dth_age_custom$dob, -->
<!--                         breaks = c(0, 2, 5, 8, 14), -->
<!--                         open_last = FALSE) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6} -->
<!-- plot_date_to_age_lifetab(date = dth_age_lifetab$date_death, -->
<!--                          dob = dth_age_lifetab$dob, -->
<!--                          break_max = 10) -->
<!-- ``` -->
...
<!-- plot_date_to_age_births(date = bth_in_age$date_death, -->
<!--                         dob = bth_in_age$dob) -->
<!-- ``` -->
...
<!-- plot_date_to_age_births(date = bth_out_age$date_death, -->
<!--                         dob = bth_out_age$dob, -->
<!--                         break_min = 10, -->
<!--                         break_max = 55) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6} -->
<!-- plot_date_to_age_month(date = dth_age_month$date_death[3], -->
...
<!-- ```{r, echo = FALSE, fig.height = 6} -->
<!-- plot_date_to_age_quarter(date = dth_age_quarter$date_death[3], -->
...
```{r, echo = FALSE, fig.height = 1.75}
plot_date_to_cohort_multi(date = deaths_temp$date_birth)
```
...
<!-- ```{r, echo = FALSE, fig.height = 6.5} -->
<!-- plot_date_to_triangle_year(date = dth_tri_yr$date_death, -->
<!--                            dob = dth_tri_yr$dob, -->
<!--                            break_max = 10) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6.5} -->
<!-- plot_date_to_triangle_multi(date = dth_tri_multi$date_death, -->
...
<!-- ```{r, echo = FALSE, fig.height = 6.5} -->
<!-- plot_date_to_triangle_births(date = births_in_tri$date_death, -->
<!--                              dob = births_in_tri$dob) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6.5} -->
<!-- plot_date_to_triangle_quarter(date = dth_tri_qu$date_death, -->
<!--                               dob = dth_tri_qu$dob, -->
<!--                               break_max = 24) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE, fig.height = 6} -->
<!-- plot_date_to_triangle_month(date = dth_tri_month$date_death[3], -->
