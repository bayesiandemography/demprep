...
test_that("date_to_cohort_year gives correct answers with valid inputs", {
    ...
    expect_identical(date_to_cohort_year(date = c(NA, NA)),
...
test_that("date_to_cohort_multi gives correct answers with valid inputs", {
    expect_identical(date_to_cohort_multi(date = c("2003-03-20", "2001-02-11", "2010-12-30"),
                                          width = 5,
                                          origin = 2000,
                                          month_start = "Jan",
    ...
    expect_identical(date_to_cohort_multi(date = c(NA, "2003-03-20", "2001-02-11", "2010-12-30"),
                                          width = 10,
                                          month_start = "Jan",
                                          origin = 2000,
                                          break_min = as.Date("1990-01-01"),
    ...
    expect_identical(date_to_cohort_multi(date = character()),
                     factor())
    expect_identical(date_to_cohort_multi(date = c(NA, NA)),
                     factor(c(NA_character_, NA_character_),
                            levels = NA_character_,
                            exclude = NULL))
    expect_identical(date_to_cohort_multi(date = character(),
...
test_that("date_to_cohort_custom gives correct answers with valid inputs", {
    ...
    expect_identical(date_to_cohort_custom(date = c("2003-03-20",
                     ...
                     factor(c("2000-2006", "2000-2006", NA, "2006-2020", "<2000"),
                            levels = c("<2000", "2000-2006", "2006-2020", NA),
                            exclude = NULL))
    expect_identical(date_to_cohort_custom(date = c(NA, NA),
                                           breaks = c("2001-04-01",
                                                      "2003-04-01")),
                     factor(c(NA_character_, NA_character_),
                            levels = c("<2001", "2001-2003", NA),
                            exclude = NULL))
    expect_identical(date_to_cohort_custom(date = c(NA, NA),
                                           breaks = c("2001-04-01",
                                                      "2003-04-01"),
